...
export default createStore({
  state: loadState() || {
    players: [
      { id: 1, avatar: require('@/assets/img/player/avatar1.jpg'), lastName: 'Семенов', firstName: 'Алексей', middleName: 'Иванович', age: 26, position: 'ЦАП', goals: 3, parameters: '180/75', stats: { speed: 60, pass: 65, dribbling: 50, defense: 90, fitness: 85 } },
      { id: 2, avatar: require('@/assets/img/player/avatar2.jpg'), lastName: 'Иванов', firstName: 'Сергей', middleName: 'Петрович', age: 24, position: 'ЦНП', goals: 5, parameters: '175/70', stats: { speed: 70, pass: 80, dribbling: 65, defense: 75, fitness: 90 } },
      { id: 3, avatar: require('@/assets/img/player/avatar3.jpg'), lastName: 'Петров', firstName: 'Александр', middleName: 'Викторович', age: 28, position: 'ЛПЗ', goals: 2, parameters: '185/80', stats: { speed: 72, pass: 78, dribbling: 60, defense: 85, fitness: 88 } },
      { id: 4, avatar: require('@/assets/img/player/avatar4.jpg'), lastName: 'Сидоров', firstName: 'Максим', middleName: 'Анатольевич', age: 27, position: 'ЛЗ', goals: 1, parameters: '178/72', stats: { speed: 65, pass: 70, dribbling: 58, defense: 87, fitness: 84 } },
      { id: 5, avatar: require('@/assets/img/player/avatar5.jpg'), lastName: 'Козлов', firstName: 'Андрей', middleName: 'Владимирович', age: 30, position: 'ГП', goals: 0, parameters: '170/68', stats: { speed: 50, pass: 60, dribbling: 55, defense: 92, fitness: 78 } },
      { id: 6, avatar: require('@/assets/img/player/avatar6.jpg'), lastName: 'Федоров', firstName: 'Дмитрий', middleName: 'Евгеньевич', age: 25, position: 'ЦЗ', goals: 2, parameters: '190/85', stats: { speed: 75, pass: 72, dribbling: 65, defense: 90, fitness: 89 } },
      { id: 7, avatar: require('@/assets/img/player/avatar7.jpg'), lastName: 'Васильев', firstName: 'Олег', middleName: 'Сергеевич', age: 23, position: 'ЛФА', goals: 4, parameters: '177/74', stats: { speed: 85, pass: 80, dribbling: 80, defense: 70, fitness: 92 } },
      { id: 8, avatar: require('@/assets/img/player/avatar8.jpg'), lastName: 'Новиков', firstName: 'Артем', middleName: 'Валерьевич', age: 26, position: 'ПФА', goals: 3, parameters: '182/78', stats: { speed: 80, pass: 75, dribbling: 70, defense: 85, fitness: 90 } },
      { id: 9, avatar: require('@/assets/img/player/avatar9.jpg'), lastName: 'Денисов', firstName: 'Виктор', middleName: 'Олегович', age: 29, position: 'ЦОП', goals: 1, parameters: '185/80', stats: { speed: 70, pass: 68, dribbling: 60, defense: 88, fitness: 87 } },
      { id: 10, avatar: require('@/assets/img/player/avatar10.jpg'), lastName: 'Егоров', firstName: 'Павел', middleName: 'Николаевич', age: 31, position: 'ЛП', goals: 3, parameters: '179/77', stats: { speed: 74, pass: 77, dribbling: 68, defense: 82, fitness: 85 } },
      { id: 11, avatar: require('@/assets/img/player/avatar11.jpg'), lastName: 'Захаров', firstName: 'Николай', middleName: 'Иванович', age: 24, position: 'ПП', goals: 2, parameters: '176/70', stats: { speed: 60, pass: 65, dribbling: 52, defense: 89, fitness: 80 } },
      { id: 12, avatar: require('@/assets/img/player/avatar12.jpg'), lastName: 'Романов', firstName: 'Сергей', middleName: 'Викторович', age: 22, position: 'ЦН', goals: 6, parameters: '183/79', stats: { speed: 78, pass: 82, dribbling: 76, defense: 80, fitness: 92 } },
      { id: 13, avatar: require('@/assets/img/player/avatar13.jpg'), lastName: 'Лебедев', firstName: 'Алексей', middleName: 'Аркадьевич', age: 27, position: 'ГП', goals: 1, parameters: '180/74', stats: { speed: 55, pass: 62, dribbling: 58, defense: 91, fitness: 77 } },
      { id: 14, avatar: require('@/assets/img/player/avatar14.jpg'), lastName: 'Борисов', firstName: 'Михаил', middleName: 'Дмитриевич', age: 25, position: 'РВ', goals: 5, parameters: '176/73', stats: { speed: 72, pass: 70, dribbling: 65, defense: 80, fitness: 88 } },
      { id: 15, avatar: require('@/assets/img/player/avatar15.jpg'), lastName: 'Григорьев', firstName: 'Юрий', middleName: 'Павлович', age: 28, position: 'ЛВ', goals: 4, parameters: '182/76', stats: { speed: 70, pass: 75, dribbling: 72, defense: 80, fitness: 86 } },
      { id: 16, avatar: require('@/assets/img/player/avatar16.jpg'), lastName: 'Михайлов', firstName: 'Виктор', middleName: 'Степанович', age: 26, position: 'ПЗ', goals: 2, parameters: '184/81', stats: { speed: 67, pass: 68, dribbling: 60, defense: 89, fitness: 84 } },
      { id: 17, avatar: require('@/assets/img/player/avatar17.jpg'), lastName: 'Александров', firstName: 'Денис', middleName: 'Юрьевич', age: 23, position: 'ЦЗ', goals: 1, parameters: '179/73', stats: { speed: 64, pass: 70, dribbling: 55, defense: 87, fitness: 80 } },
      { id: 18, avatar: require('@/assets/img/player/avatar18.jpg'), lastName: 'Королев', firstName: 'Аркадий', middleName: 'Владимирович', age: 29, position: 'ЦП', goals: 3, parameters: '188/82', stats: { speed: 75, pass: 74, dribbling: 68, defense: 84, fitness: 89 } },
      { id: 19, avatar: require('@/assets/img/player/avatar19.jpg'), lastName: 'Тимофеев', firstName: 'Олег', middleName: 'Геннадьевич', age: 31, position: 'ЦППЗ', goals: 6, parameters: '182/75', stats: { speed: 80, pass: 78, dribbling: 75, defense: 82, fitness: 90 } },
      { id: 20, avatar: require('@/assets/img/player/avatar20.jpg'), lastName: 'Смирнов', firstName: 'Василий', middleName: 'Викторович', age: 27, position: 'ГП', goals: 0, parameters: '170/68', stats: { speed: 58, pass: 60, dribbling: 54, defense: 90, fitness: 75 } }
    ],
    matches: [
